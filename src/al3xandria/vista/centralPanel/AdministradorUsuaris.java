...
public class AdministradorUsuaris extends JPanel {
	...
	public void iniciarComponents() {
		...
		carnetRadioButton = new JRadioButton(CentralPanelMessages.getString("AdministradorUsuaris.carnetRadioButton.text"));
		...
		inactiusRadioButton = new JRadioButton(CentralPanelMessages.getString("AdministradorUsuaris.inactiusRadioButton.text"));
		...
		filtreComboBox.setToolTipText(CentralPanelMessages.getString("AdministradorUsuaris.filtreComboBox.toolTipText")); //$NON-NLS-1$
		...
		mostrarButton = new JButton("Mostrar"); //$NON-NLS-1$
		...
		editarUsuariButton = new JButton(CentralPanelMessages.getString("AdministradorUsuaris.editarUsuariButton.text"));
		...
		confirmarButton.setToolTipText(CentralPanelMessages.getString("AdministradorUsuaris.confirmarButton.toolTipText")); //$NON-NLS-1$
		...
		cancellarButton.setToolTipText(CentralPanelMessages.getString("AdministradorUsuaris.cancellarButton.toolTipText")); //$NON-NLS-1$
