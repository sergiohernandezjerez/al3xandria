...
public class CreateLlibres {
	...
	private void createLlibres() {
		...
		Llibres llibre4 = new Llibres(4, "4851234567894", "C++ a fondo", "02-12-2015", "Tercera", 874, 1, sinopsi, 547, "Arnesto Arigani", "Mc Graw C", "Java", false);
		...
		Llibres llibre7 = new Llibres(7, "1234568564895", "Rust a fondo", "15-01-2000", "Primera", 2, 2, sinopsi, 547, "Richard Deal", "Anaya Multimedia", "Android", false);
		Llibres llibre8 = new Llibres(8, "5689874582135", "CSS a fondo", "16-02-2021", "Primera", 78, 3, sinopsi, 569, "Richard Deal", "Rama", "Web", false);
		Llibres llibre9 = new Llibres(9, "4586543265984", "Visual Basic a fondo", "19-04-2001", "Tercera", 458, 5, sinopsi, 1254, "Richard Deal", "Mc Graw Gill", "Visual", false);
		...
		Llibres llibre11 = new Llibres(11, "5688844456315", "SQL a fondo", "28-10-2006", "Primera", 10, 1, sinopsi, 741, "Maximo Nuñez", "Marcombo", "SQL", false);
